...
Papers 1 and 2 use the above theorem together together with the fact that $(\bA \bS^{-1} \bA^\top)^{-1}$ will also follow a Wishart distributions given some restrictions on the matrix $\bA$.
